  ...
  return (
    <div>
      <div className="flex items-center justify-center min-h-screen bg-bg_color">
        <div className="flex items-center justify-between text-#3F497F">
          <div className="flex flex-col px-20 p-20 mt-20">
            <p className="font-bold text-6xl text-main_text">
              Build a job-winning
              <br /> resume for free.
            </p>
            <span className="text-xl text-gray p-0 ">
          ...
          <Image
            className="h-80 py-2 pr-4 ml-8 gap-10"
            src={Resume}
